...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="w-full bg-[#fbf7ee] border-b-2 border-stone-900 select-none">
      {/* Top Dateline Bar */}
      <div className="border-b border-stone-800 px-3 sm:px-6 py-1.5 flex flex-wrap items-center justify-between text-xs font-newspaper tracking-wider text-stone-800">
        <div className="flex items-center gap-2 sm:gap-3 font-semibold font-treatise">
          <span>VOL. LVIII — NO. {currentPuzzle.editionNumber}</span>
          <span className="text-stone-400">•</span>
          <span>SAN FRANCISCO & GLOBAL EDITIONS</span>
        </div>
